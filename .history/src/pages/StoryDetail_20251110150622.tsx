  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="w-full max-w-full mx-auto mb-12 overflow-hidden shadow-2xl -mx-4 sm:-mx-6 lg:-mx-8"
          variants={fadeInUp(0.3)}
        >
          <img
            src={story.images && story.images.length > 0 ? story.images[0] : story.image}
            alt={story.title}
            className="w-full h-[400px] sm:h-[500px] lg:h-[650px] xl:h-[700px] object-cover"
          />
        </motion.div>
