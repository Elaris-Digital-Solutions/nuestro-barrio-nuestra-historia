      ...
      >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            {/* Left: Image */}
            <motion.div 
              className="overflow-hidden rounded-2xl shadow-lg order-2 lg:order-1"
            ...
            >
              ...
              {/* Metadata */}
              <motion.div
                className="flex items-center gap-4 sm:gap-6 flex-wrap text-muted-foreground"
