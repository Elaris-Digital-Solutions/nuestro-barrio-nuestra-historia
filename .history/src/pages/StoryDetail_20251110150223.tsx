  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="w-full max-w-7xl mx-auto mb-16 overflow-hidden rounded-2xl shadow-2xl relative"
        ...
        >
          ...
          <div className="relative h-[400px] sm:h-[500px] lg:h-[600px]">
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-8 sm:pb-12 lg:pb-16">
                <motion.div className="max-w-4xl" variants={fadeInUp(0.2)}>
                  {/* Category Badge */}
                  <motion.div className="mb-4" variants={fadeInUp(0.25)}>
                    <span className="inline-flex items-center gap-1.5 px-4 py-2 bg-primary/90 backdrop-blur-sm text-white rounded-full text-sm font-medium shadow-lg">
                  ...
                  {/* Title */}
                  <motion.h1
                    className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight drop-shadow-2xl"
                  ...
                  {/* Metadata */}
                  <motion.div
                    className="flex items-center gap-4 sm:gap-6 flex-wrap text-white/90"
                    variants={fadeInUp(0.35)}
                  >
                    <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 py-1.5 rounded-full">
                      <Calendar className="w-4 h-4" />
                      <span className="text-sm sm:text-base">{story.publishedAt}</span>
                    </div>
                    <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 py-1.5 rounded-full">
                    ...
                    <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 py-1.5 rounded-full">
                      ...
                      <span className="text-sm sm:text-base">{views} vistas</span>
                    </div>
                  </motion.div>
                </motion.div>
              </div>
